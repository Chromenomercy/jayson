...
namespace Jayson {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string name, string type, string value) {
...
namespace Jayson.DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([name], [type], [value]) VALUES (@name, @type, @value)" +
                ";\r\nSELECT name, type, value FROM [Table] WHERE (name = @name)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [name] = @name, [type] = @type, [value] = @value WHERE (" +
                "([name] = @Original_name));\r\nSELECT name, type, value FROM [Table] WHERE (name =" +
                " @name)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Jayson.Properties.Settings.Default.DictionaryConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT name, type, value FROM dbo.[Table]";
        ...
        public virtual int Insert(string name, string type, string value) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string type, string value, string Original_name) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string type, string value, string Original_name) {
            return this.Update(Original_name, type, value, Original_name);
        }
    }
